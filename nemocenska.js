(function(){
  ...
  function calculate(){
    ...
    text("employerPhaseAmount",fmt(r.employer));text("csszPhaseAmount",fmt(r.cssz));text("phaseSummary",r.cssz>0?"2 navazující období":"pouze první období");setTrack("employerTrack",r.employer,r.total);setTrack("csszTrack",r.cssz,r.total);
