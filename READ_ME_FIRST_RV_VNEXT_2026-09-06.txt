...
3) RV_ADSENSE_REVIEW_REQUIRED_AUDIT_2026-09-11.md
4) RV_VNEXT_MASTER_PROMPT.txt
5) RV-VNEXT-STRICT-BUILD-PROMPT-2026-09-06.md
6) RV-VNEXT-PRODUCTION-STANDARD.md
7) aktuální recovery / experience / customer-copy dokumenty v main
8) RV_VNEXT_PROGRESS.json + skutečný relevantní HTML/CSS/JS + benchmark/data files
