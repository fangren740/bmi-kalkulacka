...
2) RV_ADSENSE_FINISH_MODE_2026-09-11.md
3) RV_ADSENSE_FINISH_QUEUE_2026-09-11.md
4) RV_ADSENSE_REVIEW_REQUIRED_AUDIT_2026-09-11.md
5) RV_VNEXT_MASTER_PROMPT.txt
6) RV-VNEXT-STRICT-BUILD-PROMPT-2026-09-06.md
7) RV-VNEXT-PRODUCTION-STANDARD.md
8) aktuální recovery / experience / customer-copy dokumenty v main
9) RV_VNEXT_PROGRESS.json + skutečný relevantní HTML/CSS/JS + benchmark/data files
...
- Pokud starší prompt odporuje current master/strict/production standardu, platí novější dokument; pro pořadí finish sprintu a stop-loss platí `RV_ADSENSE_FINISH_MODE_2026-09-11.md`; pro obsahovou hloubku a V7/V3.2 identitu platí `RV_CONTENT_DEPTH_AND_IDENTITY_LOCK_2026-09-11.md`.
